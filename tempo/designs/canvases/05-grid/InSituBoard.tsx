          ...
          <div style={{ width: 440, background: "#fff", borderRadius: 16, overflow: "hidden", border: "1px solid #ebebeb" }}>
            ...
            <div style={{ padding: 16, display: "flex", flexDirection: "column", gap: 12 }}>
              ...
              <div style={{ display: "flex", gap: 8, flexWrap: "wrap", marginTop: 4 }}>
                <span style={{ background: "#f7f7f7", padding: "6px 12px", borderRadius: 999, fontFamily: FONT_SANS, fontSize: 12, color: "#222" }}>
                  Sea view
                </span>
                <span style={{ background: "#f7f7f7", padding: "6px 12px", borderRadius: 999, fontFamily: FONT_SANS, fontSize: 12, color: "#222" }}>
                  Wifi
        ...
        <div style={{ background: "#fff", padding: 32, borderRadius: 12, display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 24 }}>
          <div style={{ background: "#fff", border: "1px solid #ebebeb", borderRadius: 16, overflow: "hidden" }}>
            ...
            <div style={{ padding: 16, display: "flex", flexDirection: "column", gap: 8 }}>
              ...
              <p style={{ fontFamily: FONT_SANS, fontSize: 12.5, color: "#717171", margin: 0 }}>Cinque Terre · $248</p>
            </div>
          </div>
          <div style={{ background: "#fff", border: "1px solid #ebebeb", borderRadius: 16, overflow: "hidden" }}>
            <div style={{ height: 160, background: "#ddd" }} />
            <div style={{ padding: 16, display: "flex", flexDirection: "column", gap: 8 }}>
              <p style={{ fontFamily: FONT_SANS, fontSize: 14, fontWeight: 600, color: "#222", margin: 0 }}>Riad rooftop pool</p>
              <p style={{ fontFamily: FONT_SANS, fontSize: 12.5, color: "#717171", margin: 0 }}>Marrakech · $195</p>
            </div>
          </div>
          <div style={{ background: "#fff", border: "1px solid #ebebeb", borderRadius: 16, overflow: "hidden" }}>
            <div style={{ height: 160, background: "#ddd" }} />
            <div style={{ padding: 16, display: "flex", flexDirection: "column", gap: 8 }}>
              ...
              <p style={{ fontFamily: FONT_SANS, fontSize: 12.5, color: "#717171", margin: 0 }}>Lake Louise · $312</p>
            </div>
          </div>
        </div>
      </Section>
