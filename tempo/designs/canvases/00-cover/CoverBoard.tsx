    ...
    >
      ...
      >
        ...
        <div style={{ position: "absolute", top: "217px", left: "68px", display: "flex", gap: 18, background: "#fff", padding: 20, borderRadius: 18, boxShadow: "0 0 0 18px #1f1f1f, 0 4px 8px rgba(255,255,255,0.10), 0 12px 32px rgba(255,255,255,0.18)" }}>
          <div style={{ width: 84, height: 84, display: "flex", alignItems: "center", justifyContent: "center", borderRadius: 12, background: "#f7f7f7" }}>
            <ArrowDown size={40} strokeWidth={1.75} color="#222" />
          </div>
          <div style={{ width: 84, height: 84, display: "flex", alignItems: "center", justifyContent: "center", borderRadius: 12, background: "transparent" }}>
            <ArrowRight size={40} strokeWidth={1.75} color="#222" />
          </div>
          <div style={{ width: 84, height: 84, display: "flex", alignItems: "center", justifyContent: "center", borderRadius: 12, background: "transparent" }}>
            <Send size={40} strokeWidth={1.75} color="#222" />
          </div>
        </div>
        ...
        <div style={{ position: "absolute", left: "502px", display: "flex", gap: 18, background: "#fff", padding: 26, borderRadius: 20, boxShadow: "0 0 0 18px #1f1f1f, 0 4px 8px rgba(255,255,255,0.10), 0 12px 32px rgba(255,255,255,0.18)", top: "844px" }}>
          <div style={{ width: 76, height: 76, display: "flex", alignItems: "center", justifyContent: "center", borderRadius: 12 }}>
            <Heart size={38} strokeWidth={1.75} color="#222" />
          </div>
          <div style={{ width: 76, height: 76, display: "flex", alignItems: "center", justifyContent: "center", borderRadius: 12 }}>
            <Search size={38} strokeWidth={1.75} color="#222" />
          </div>
          <div style={{ width: 76, height: 76, display: "flex", alignItems: "center", justifyContent: "center", borderRadius: 12 }}>
            <Star size={38} strokeWidth={1.75} color="#222" />
          </div>
          <div style={{ width: 76, height: 76, display: "flex", alignItems: "center", justifyContent: "center", borderRadius: 12 }}>
            <MapPin size={38} strokeWidth={1.75} color="#222" />
          </div>
        </div>
